...
import { GetGradeOptions, GetGradeResult } from '../features/courses/course-types';
...
interface GetGradingPolicyOptions {
    endDate: Date;
    deadDate: Date;
    locked: boolean;
...
export interface GetGradingPolicyResult {
    isCompleted: boolean;
    isExpired: boolean;
    isLocked: boolean;
...
export const getGradingPolicy = ({
    ...
    solutionDate
}: GetGradingPolicyOptions): GetGradingPolicyResult => {
    ...
    const isExpired = theMoment.isAfter(solutionDate);
    ...
    export const getGrade = ({
        ...
        solutionDate,
        newScore,
    }: GetGradeOptions): GetGradeResult => {
        const gradingPolicy: GetGradingPolicyResult = getGradingPolicy({
